function getSlotDetails() {
  let slots = JSON.parse(localStorage.getItem("users"));
...
<option value='others'>others</option>
              ...
              <div class="cust-desc">
                  ...
                  ${res.data
                    .map(function (work) {
                      ...
                      <li>Date :${new Date(work.date).toDateString()}</li>
      ...
      <div class="row">
          ...
          ${
            token
              ? `<form action='/payment-stripe-home' method="POST"> 
          ...
          CONTINUE
              ...
              : `<a href='/check-out-signin/home'> <button  
